...
def top_songs_list(artist_id):
    ...
    # print(playlists_content.json()['data'])
    '''Add playlist content to top_songs_list'''
    for list in playlists_content.json()['data']:
      print(len(list['relationships']['tracks']['data']))
      print("-----------------")
      for song in list['relationships']['tracks']['data']:
        top_songs_list.append(song)
    '''Remove duplicates'''
